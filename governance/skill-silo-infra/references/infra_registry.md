...
## 🤖 Modelo Activo
- **Modelo:** `glm-5.2` (GLM 5.2) via `ollama-cloud`
- **Rendimiento:** Buen desempeño en tareas complejas (multi-tool, razonamiento, estructuración)
- **Nota:** Cambio de modelo requiere `/restart` para tomar efecto completo
- **OpenRouter API key:** Removido permanentemente del `.env` por decisión de Santiago
